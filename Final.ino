...
void loop() {
  flag = Firebase.getInt("Flag");
  if(flag%2==0){
    Serial.println("Player 1 Its your turn");
...
// Update the matrix on Firebase
      flag = flag + 1;
      Firebase.setInt("Flag",flag);
      Firebase.setString("Matrix",result);
      result = Firebase.getString("Matrix");
